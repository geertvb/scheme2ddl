package com.googlecode.scheme2ddl.utils;
...
public class FileNameConstructor implements InitializingBean {
    ...
    //TODO ${template}
    private String template = "types_plural/object_name.ext";

    //TODO ${templateForSysDBA}
    private String templateForSysDBA = "SCHEMA/types_plural/object_name.ext";
    private String preparedTemplate;

    @Resource(name = "sql_by_default")
    private Map<String, String> extensionMap;

    //TODO
	private boolean combinePackage = false;

    //TODO ${needToReplaceWindowsReservedFileNames}
    private boolean needToReplaceWindowsReservedFileNames = true;
